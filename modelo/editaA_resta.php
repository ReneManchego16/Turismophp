...
<body>
    <div class="container">
        <div class="card">
            ...
            $orden = "INSERT INTO `restaurante` (`nombre`, `direccion`, `correo`, `telefono`, `resena`, `fk_nomciudad`) VALUES ('$nombre', '$direccion', '$email', '$telefono', '$resena', '$ciudad')";
            $rs = mysqli_query($link, $orden) or die("Fallo en la consulta");

            if ($rs == 1) {
                echo '<div class="h1 font-weight-bold" role="alert">';
                echo 'El registro del nuevo restaurante fue insertado con éxito, suerte en tu negocio';
                echo '</div>';
                echo '<hr>';
                echo '<a class="btn btn-primary font-weight-bold" href="../vista/residente/menu_residente.php">Retornar</a>';
            } else {
                echo '<div class="alert alert-danger" role="alert">';
                echo 'Error al insertar el registro de nuevo restaurante';
                echo '</div>';
                echo '<br>';
                echo '<br>';
