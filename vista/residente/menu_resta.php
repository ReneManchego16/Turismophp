...
<body>
  ...
  <div class="container">
    <div class="jumbotron">
      ...
      <p class="lead">Estás en el menú de Restaurantes</p>
    </div>
    
    <div class="row">
      <div class="col-md-4">
        <form method="post" action="./formA_agregarresta.php" enctype="multipart/form-data" class="form">
          <input type="submit" value="Agregar" name="Agregar" class="btn btn-danger btn-lg btn-block">
        </form>
      </div>
      <div class="col-md-4">
        <form method="post" action="./formA_editarresta.php" enctype="multipart/form-data" class="form">
          <input type="submit" value="Editar" name="Editar" class="btn btn-danger btn-lg btn-block">
        </form>
      </div>
      <div class="col-md-4">
        <form method="post" action="./formA_listarresta.php" enctype="multipart/form-data" class="form">
