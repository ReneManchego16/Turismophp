...
<body>
    <div class="container">
        <article>
            ...
            ?>
            <form method="post" action="../../modelo/editaA_resta.php" enctype="multipart/form-data">
                <h3 class="mb-4">EDITAR RESTAURANTE</h3>
                ...
                <input type="submit" class="btn btn-primary" value="Actualizar Restaurante" />
                <input type="hidden" value="<?= $id ?>" name="id">
            </form>
            <a class="btn btn-secondary mt-3" href="formA_listarresta.php">Volver</a>
        </article>
    </div>
