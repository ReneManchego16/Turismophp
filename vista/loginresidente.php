          ...
          <div class="row">
            <div class="col-md-6">
              <div class="m-5 text-center">
                <h1>Inicio de Sesion <br> (Residente)</h1>
              </div>
              <form class="m-5" action="../controlador/control_residente.php" method="post" name="login">
                <div class="mb-3">
                ...
                <br>
                <div>
                  <label>Si eres Turista,<br> ingresa este enlace...</label><br><br>
                  <a href="login.php"> Turista </a>
                </div>
              </form>
            </div>
            <div class="col-md-6">
              <div class="text-center">
                <img src="../resources/images/R.png" alt="login" class="img-fluid p-5">
              </div>
            </div>
          </div>
        </div>
